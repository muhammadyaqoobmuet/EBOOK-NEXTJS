...
const Banner = () => {
  return (
    <div className="rounded-md shadow-black p-5 relative overflow-hidden">
      <Image alt="book-image" width={1000} height={1}  className="w-screen h-[20rem] rounded-lg shadow-orange-300/30 shadow-md" src="/bookBanner.jpg" />
